...
pip install psutil 'coverage<5' 'pytest<3.7; python_version<"3.7"' 'pytest; python_version>="3.7"' 'pytest-cov<2.10; python_version<"3.7"' 'pytest-cov; python_version>="3.7"' coveralls trustme || fail "Failed to install unit test dependencies"
