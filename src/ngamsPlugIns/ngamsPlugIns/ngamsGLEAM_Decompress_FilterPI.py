...
def isGLEAMImageTar(fileId):
    return (fileId.endswith('_images.tar') and (len(fileId.split('_')) == 2))


def ngamsGLEAM_Decompress_FilterPI(srvObj,
                          plugInPars,
                          filename,
                          fileId,
                          fileVersion = -1,
