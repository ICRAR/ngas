...
from ngamsLib.ngamsCore import getHostName, NGAMS_LABEL_CMD, rmFile
from ngamsTestLib import ngamsTestSuite, sendExtCmd, getNoCleanUp, runTest
...
class ngamsLabelCmdTest(ngamsTestSuite):
    ...
    def test_LabelCmd_1(self):
        ...
        if (not getNoCleanUp()): rmFile(tmpStatFile)
